$(document).ready(function(){
    $('#panel1').hover(function() {
    	document.getElementById('catchphrase').innerHTML ='Basecamp is the project management tool you wish you had on your last project' ;
    	...
    	function(){
    	document.getElementById('catchphrase').innerHTML ='Making collaboration productive and enjoyable for people every day.' ;
    ...
    $('#panel2').hover(function() {
    	document.getElementById('catchphrase').innerHTML ='Highrise remembers the important things about people youd normally forget' ;
    ...
    $('#panel3').hover(function() {
    	document.getElementById('catchphrase').innerHTML ='From near or far, Campfire helps teams work over the web in real-time' ;
